---
sidebar_position: 3
description: Improving Feed Granularity
---
...
<Tabs>
  <TabItem value="a" label="Mint/Buy">
...
```
  ...
  <TabItem value="b" label="Send/Burn">
...
```json
{
    ...
    "attachments": [
        { "type": "preview", "address": "https://assets.poap.xyz/rss3-aries-meetup-2022-2022-logo-1649235765400.png", "mime_type": "text/html; charset=UTF-8" },
        { "type": "external_url", "mime_type": "text/uri-list" },
        { "type": "start_date", "content": "06-Apr-2022", "mime_type": "text/plain" },
        { "type": "end_date", "content": "06-Apr-2022", "mime_type": "text/plain" },
        { "type": "expiry_date", "content": "06-May-2022", "mime_type": "text/plain" }
    ],
    "source": "Ethereum NFT",
    "metadata": {
        "from": "0x0",
